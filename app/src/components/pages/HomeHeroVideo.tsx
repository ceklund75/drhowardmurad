...
export function HomeHeroVideo({ hero }: HomeHeroVideoProps) {
  ...
  return (
    <section className="relative min-h-[360px] overflow-hidden md:min-h-[520px] lg:min-h-[640px] xl:min-h-[760px]">
      ...
      <div className="relative z-10 hidden min-h-[360px] md:flex md:min-h-[520px] lg:min-h-[640px] xl:min-h-[760px]">
        <div className="mx-auto flex w-full max-w-7xl px-6">
          {/* Left: text */}
          <div className="flex w-7/12 items-center">
            <div className="space-y-3">
              {heroSubheading && (
                <h4 className="text-[clamp(1.125rem,1.4vw+0.8rem,2.75rem)] text-[var(--color-medium-purple)]">
                  {heroSubheading}
                </h4>
              )}
              {heroHeading && (
                <h1 className="text-[clamp(2.25rem,4vw+1rem,5.5rem)] leading-none text-balance text-[var(--color-blue-heading)]">
                  {heroHeading}
                </h1>
              )}
            </div>
          ...
          <div className="flex w-5/12 items-end justify-end">
            {heroRightImage?.node?.mediaItemUrl && (
              <div className="translate-x-2 md:translate-x-6 lg:translate-x-10">
                <div className="relative h-[360px] w-[266px] md:h-[480px] md:w-[355px] lg:h-[640px] lg:w-[472px] xl:h-[740px] xl:w-[548px]">
                  <Image
      ...
      <div className="flex w-full flex-col items-center justify-center gap-4 py-10 md:hidden">
        {heroRightImage?.node?.mediaItemUrl && (
